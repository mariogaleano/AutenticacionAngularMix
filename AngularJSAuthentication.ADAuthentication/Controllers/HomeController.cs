...
using AngularJSAuthentication.ADAuthentication.Models;

namespace AngularJSAuthentication.ADAuthentication.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> UserProfile()
        {
            ...
            ViewBag.AuthenticationHeader = authHeader;
